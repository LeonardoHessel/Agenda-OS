...
namespace Agenda_OS.agendaDataSetTableAdapters {
    ...
    public partial class empresaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `cnpj`, `ie`, `razao`, `nome`, `regime`, `contador`, `logradouro`, `" +
                "numero`, `complemento`, `cep`, `bairro`, `municipio`, `uf`, `email`, `telefone`," +
                " `observacao`, `ativo` FROM `empresa`";
        ...
        public virtual int Fill(agendaDataSet.empresaDataTable dataTable) {
        ...
        public virtual agendaDataSet.empresaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            agendaDataSet.empresaDataTable dataTable = new agendaDataSet.empresaDataTable();
